...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230328205656_CreateSessionsTableAndItsRelations")]
    partial class CreateSessionsTableAndItsRelations
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 0, 56, 55, 145, DateTimeKind.Utc).AddTicks(5634));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 0, 56, 55, 145, DateTimeKind.Utc).AddTicks(6469));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 0, 56, 55, 117, DateTimeKind.Utc).AddTicks(8612));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 0, 56, 55, 132, DateTimeKind.Utc).AddTicks(9511));
