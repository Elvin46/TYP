...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230402130503_EditRelationBetweenDepartmentAndFaculty")]
    partial class EditRelationBetweenDepartmentAndFaculty
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 2, 17, 5, 2, 324, DateTimeKind.Utc).AddTicks(5614));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 2, 17, 5, 2, 324, DateTimeKind.Utc).AddTicks(6548));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 2, 17, 5, 2, 294, DateTimeKind.Utc).AddTicks(8736));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 2, 17, 5, 2, 311, DateTimeKind.Utc).AddTicks(5593));
