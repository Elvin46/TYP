...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230328161452_AddOrderByColumnToPredmetProfessionsTable")]
    partial class AddOrderByColumnToPredmetProfessionsTable
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 28, 20, 14, 51, 752, DateTimeKind.Utc).AddTicks(5469));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 28, 20, 14, 51, 752, DateTimeKind.Utc).AddTicks(7342));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 28, 20, 14, 51, 705, DateTimeKind.Utc).AddTicks(2444));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 28, 20, 14, 51, 731, DateTimeKind.Utc).AddTicks(1004));
            ...
            modelBuilder.Entity("TYP.Core.Entities.TeacherPredmet", b =>
                {
                    ...
                    b.Property<int?>("PredmetProfessionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PredmetProfessionId");
            ...
            modelBuilder.Entity("TYP.Core.Entities.TeacherPredmet", b =>
                {
                    ...
                    b.HasOne("TYP.Core.Entities.PredmetProfession", "PredmetProfession")
                        .WithMany()
                        .HasForeignKey("PredmetProfessionId");
                    ...
                    b.Navigation("PredmetProfession");
