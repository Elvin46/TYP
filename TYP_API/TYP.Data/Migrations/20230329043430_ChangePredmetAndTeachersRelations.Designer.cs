...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230329043430_ChangePredmetAndTeachersRelations")]
    partial class ChangePredmetAndTeachersRelations
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 8, 34, 30, 254, DateTimeKind.Utc).AddTicks(284));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 8, 34, 30, 254, DateTimeKind.Utc).AddTicks(972));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 8, 34, 30, 228, DateTimeKind.Utc).AddTicks(7955));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 8, 34, 30, 243, DateTimeKind.Utc).AddTicks(7244));
