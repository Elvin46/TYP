...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230326000207_LevelToTeacherSectorsTable")]
    partial class LevelToTeacherSectorsTable
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 26, 4, 2, 7, 120, DateTimeKind.Utc).AddTicks(1002));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 26, 4, 2, 7, 120, DateTimeKind.Utc).AddTicks(1798));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 26, 4, 2, 7, 95, DateTimeKind.Utc).AddTicks(2468));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 26, 4, 2, 7, 108, DateTimeKind.Utc).AddTicks(6559));
