...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230314065911_CreateRelationBetweenPredmetAndDepartment")]
    partial class CreateRelationBetweenPredmetAndDepartment
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 10, 59, 10, 126, DateTimeKind.Utc).AddTicks(9328));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 10, 59, 10, 127, DateTimeKind.Utc).AddTicks(609));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 10, 59, 10, 80, DateTimeKind.Utc).AddTicks(6695));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 10, 59, 10, 104, DateTimeKind.Utc).AddTicks(9494));
