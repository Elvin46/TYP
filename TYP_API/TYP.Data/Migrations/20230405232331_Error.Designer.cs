...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230405232331_Error")]
    partial class Error
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 6, 3, 23, 30, 676, DateTimeKind.Utc).AddTicks(2215));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 6, 3, 23, 30, 676, DateTimeKind.Utc).AddTicks(3480));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 6, 3, 23, 30, 657, DateTimeKind.Utc).AddTicks(2226));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 6, 3, 23, 30, 663, DateTimeKind.Utc).AddTicks(752));
