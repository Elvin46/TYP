...
namespace TYP.Data.Migrations
{
    ...
    [Migration("20230403220705_CreateAutenticationTables")]
    partial class CreateAutenticationTables
    {
            ...
            modelBuilder.Entity("TYP.Core.Entities.Predmet", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 4, 2, 7, 3, 867, DateTimeKind.Utc).AddTicks(7518));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 4, 2, 7, 3, 867, DateTimeKind.Utc).AddTicks(9682));
            ...
            modelBuilder.Entity("TYP.Core.Entities.Teacher", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 4, 2, 7, 3, 837, DateTimeKind.Utc).AddTicks(8422));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 4, 4, 2, 7, 3, 848, DateTimeKind.Utc).AddTicks(3665));
